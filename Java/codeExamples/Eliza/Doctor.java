 ...
 * <p>
 * The program appears to have a conversation with the user, using string
 * replacement
 * and basic parsing, to give the appearance of understanding what the user
 * types.
 * <p>
 * The responses are based on a Python program by Joe Strout, Jeff Epler and Jez
 * Higgins.
 * <p>
...
public class Doctor {
    ...
    private static final List<List<String>> RESPONSES = List.of(
            List.of("Life? Don't talk to me about life.", "At least you have a life, I'm stuck inside this computer.",
            ...
            List.of("Do you think you should be able to %1?", "If you could %1, what would you do?",
                    "I don't know -- why can't you %1?", "Have you really tried?"),
            List.of("How do you know you can't %1?", "Perhaps you could %1 if you tried.",
                    "What would it take for you to %1?"),
            List.of("Did you come to me because you are %1?", "How long have you been %1?",
                    "How do you feel about being %1?"),
            List.of("How does being %1 make you feel?", "Do you enjoy being %1?", "Why do you tell me you're %1?",
                    "Why do you think you're %1?"),
            List.of("Why does it matter whether I am %1?", "Would you prefer it if I were not %1?",
            ...
            List.of("How do you suppose?", "Perhaps you can answer your own question.",
                    "What is it you're really asking?"),
            List.of("Is that the real reason?", "What other reasons come to mind?",
            ...
            List.of("Tell me more about your friends.", "When you think of a friend, what comes to mind?",
                    "Why don't you tell me about a childhood friend?"),
            List.of("You seem quite sure.", "OK, but can you elaborate a bit?"),
            List.of("Are you really talking about me?", "Does it seem strange to talk to a computer?",
                    "How do computers make you feel?", "Do you feel threatened by computers?"),
            List.of("Do you think it is %1?", "Perhaps it is %1 -- what do you think?",
            ...
            List.of("Why do you think I am %1?", "Does it please you to think that I'm %1?",
            ...
            List.of("Good, tell me more about these feelings.", "Do you often feel %1?", "When do you usually feel %1?",
                    "When you feel %1, what do you do?"),
            List.of("Why do you tell me that you've %1?", "Have you really %1?",
            ...
            List.of("We should be discussing you, not me.", "Why do you say that about me?",
                    "Why do you care whether I %1?"),
            List.of("Why don't you tell me the reason why %1?", "Why do you think %1?"),
            List.of("What would it mean to you if you got %1?", "Why do you want %1?",
                    "What would you do if you got %1?", "If you got %1, then what would you do?"),
            List.of("Tell me more about your mother.", "What was your relationship with your mother like?",
                    "How do you feel about your mother?", "How does this relate to your feelings today?",
                    "Good family relations are important."),
            List.of("Tell me more about your father.", "How did your father make you feel?",
                    "How do you feel about your father?",
                    "Does your relationship with your father relate to your feelings today?",
                    "Do you have trouble showing affection with your family?"),
            List.of("Did you have close friends as a child?", "What is your favorite childhood memory?",
                    "Do you remember any dreams or nightmares from childhood?",
                    "Did the other children sometimes tease you?",
                    "How do you think your childhood experiences relate to your feelings today?"),
            List.of("Why do you ask that?", "Please consider whether you can answer your own question.",
                    "Perhaps the answer lies within yourself?", "Why don't you tell me?"),
            List.of("Hello... I'm glad you could drop by today.", "Hello there... how are you today?",
                    "Hello, how are you feeling today?"),
            List.of("Hi... I'm glad you could drop by today.", "Hi there... how are you today?",
                    "Hi, how are you feeling today?"),
            List.of("Hey... I'm glad you could drop by today.", "Hey there... how are you today?",
                    "Hey, how are you feeling today?"),
            List.of("Thank you for talking with me.", "Good-bye.", "Thank you, that will be $150.  Have a good day!"),
            List.of("Please tell me more.", "Let's change focus a bit... Tell me about your family.",
                    "Can you elaborate on that?", "Why do you say that %1?", "I see.", "Very interesting.", "%1?",
                    "I see.  And what does that tell you?", "How does that make you feel?",
    ...
    public static String response(String UserInput) {
        // check through the matches list, and if there's a match, strip off the match
        // and replace with the response.
        //
        // If the response contains %1, replace that with the Remainder of the input
        // string.
        // Before replacing, change words in the Remainder of the input with the
        // corresponding entry from the reflections dictionary.
        var output = "";
        String Remainder = "";
        ...
        for (var index = 0; index < MATCHES.size(); index++) {
            ...
            if (position > -1) {
                ...
                // We need to split the input into words, to avoid changing eg. me -> you then
                // the same you -> me.
